...
export default function HomePage() {
  ...
  return (
    <>
      <UpdaterDialog />
      <div className="container mx-auto flex flex-1 flex-col items-center justify-center gap-8 p-8">
        ...
        <Card className="w-full max-w-md bg-blue-50 dark:bg-blue-950">
          <CardContent className="pt-6">
            <p className="text-center text-sm mb-3">🎓 Learn Tauri step by step</p>
            <Button
              className="w-full"
              variant="default"
              onClick={() => window.location.href = '/tutorial'}
            >
              Open Calculator Tutorial
            </Button>
          </CardContent>
        </Card>
